...
import com.app.comercial.beans.ClienteBean;
...
public class FrmClientes extends javax.swing.JFrame {
     ...
     private void consultaTabela(){
        String sql = "select cli.id, cli.nome, cli.email, cli.telefone, "
                + "cid.nome from cliente cli, cidade cid "
                + "where cli.cidade_id = cid.id";
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        cli.setCidadeId(cbxCidade.getSelectedIndex());
        cli.setEmail(txtEmail.getText());
        cli.setNome(txtCliente.getText());
        cli.setTelefone(txtFone.getText());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        cli.setId(codigo);
         ...
         if(cb.findById()){
             Cidade.carregaCombo(cbxCidade,cli.getCidadeId());
             txtCliente.setText(cli.getNome());
             txtEmail.setText(cli.getEmail());
             txtFone.setText(cli.getTelefone());
         }else{
